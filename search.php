...
{
    $sql = "select * from `cases` where `Casenumber` like '%$searchData%' or `clientName` like '%$searchData%' or `phoneNumber` like '%$searchData%' or `Address` like '%$searchData%' or `ReciptNumber` like '%$searchData%' or `ProductSKU` like '%$searchData%' or `ProductSerial` like '%$searchData%' or `ProductName` like '%$searchData%' or `CaseDescription` like '%$searchData%' or `CreatedAt` like '%$searchData%' or `Status` like '%$searchData%' or `Createdby` like '%$searchData%' or `Supplier` like '%$searchData%'   ";
